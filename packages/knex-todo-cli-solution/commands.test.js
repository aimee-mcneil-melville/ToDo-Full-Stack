...
test('listTodos returns three todos', () => {
  ...
  return commands.listTodos().then((results) => {
    // More arrange
...
test('addTodo creates a new todo', () => {
  ...
  return commands.addTodo('new test task').then((results) => {
...
test('completeTodo completes the correct todo', () => {
  ...
  return commands.completeTodo(3).then((results) => {
...
test('deleteTodo removes the correct todo', () => {
  ...
  return commands.deleteTodo(2).then((results) => {
...
test('updateTodo alters the task', () => {
  ...
  return commands.updateTodo(id, newTask).then((results) => {
...
test('findTodos returns the correct number of todos', () => {
  ...
  return commands.findTodos('test task').then((results) => {
