...
<details>
  ...
  - Your data will need to be typed. Depending on how you code the backend, you may need to use different types to that in the folder 'common', as these types are in camelCase for the frontend.
