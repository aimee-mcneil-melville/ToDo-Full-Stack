  ...
  return knex('Posts').del()
    .then(function () {
      ...
      return knex('Posts').insert([
        {id: 126, title: 'The beginning of an idea', comment_count: 0, date_created: new Date(Date.now()), paragraphs: JSON.stringify([
        ...
        {id: 125, title: 'Bad News', comment_count: 1, date_created: new Date(Date.now()), paragraphs: JSON.stringify([
        ...
        {id: 123, title: 'My first encounter with Wilber', comment_count: 2, date_created: new Date(Date.now()), paragraphs: JSON.stringify([
        ...
        {id: 124, title: 'Summer Days', date_created: new Date(Date.now()), comment_count: 0, paragraphs: JSON.stringify([
