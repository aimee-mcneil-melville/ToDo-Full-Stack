...
describe('form field values', () => {
  it('contains event data from helper', async () => {
    renderWithRedux(<EditEvent />, { initialState: {}, initialEntries: ['/events/1/edit'], route: '/events/:id/edit' })
...
describe('submit button', () => {
  it('calls helper correctly on click', async () => {
    ...
    renderWithRedux(<EditEvent />, { initialEntries: ['/events/23/edit'], route: '/events/:id/edit' })
