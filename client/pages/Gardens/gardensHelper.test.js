...
describe('getAllGardens', () => {
    ...
    it('returns correct gardens array', () => {
      ...
      return getAllGardens(consume)
        .then((gardens) => {
          ...
          expect(gardens[0].description).toBe('A test run garden for testing out gardening.')
          ...
          expect(gardens[1].description).toBe('A second test run garden for testing out gardening.')
  ...
  describe('-> on GET /gardens api call rejection', () => {
    it('dispatches error correctly', () => {
      ...
      return getAllGardens(consume)
        .then(() => {
          expect(dispatch).toHaveBeenCalledWith({ type: SHOW_ERROR, errorMessage: 'mock error' })
