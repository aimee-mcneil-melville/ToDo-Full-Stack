exports.seed = function (knex, Promise) {
  return knex('media_list').insert([
    ...
    { id: 7, user_id: 10001, genre: 'Stoner Rock', media_name: 'Rule The Beast', artist: 'Torche', link: 'https://open.spotify.com/track/0RzryWDVHhsziHkXsT2HqV?si=b42fc552b8ff497d', comment: 'The bass breakdown at 1m20s will melt your ears off' },
    { id: 8, user_id: 10001, genre: 'Synthwave', media_name: 'From Liquid', artist: 'Mt Kitty', link: 'https://open.spotify.com/track/4jQdD7SuEB9evpBL3brmbC?si=276ce37528b94b81', comment: 'Blends sythwave with some trap elements' }
