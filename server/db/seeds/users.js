exports.seed = function (knex, Promise) {
  return knex('users').insert([
    ...
    { id: 10004, first_name: 'Sloane', last_name: 'Trousers', nickname: 'SportsBall', email: 'errybodylovesmrbrown@example.org', username: 'krob', password: 'DumbStuff0@', public: true },
