exports.seed = function (knex, Promise) {
  return knex('users').insert([
    ...
    { id: 10005, first_name: 'Secret', last_name: 'Boi', nickname: 'SecretBoi2001', email: 'nobodylovesmrbrown@example.org', username: 'secrecyrulez', password: 'DumbStuff0@', public: true }
  ])
}
