  ...
  return knex('eventVolunteers').del()
    .then(function () {
      ...
      return knex('eventVolunteers').insert([
        { id: 1, user_id: 1, event_id: 3, attended: false },
        { id: 2, user_id: 2, event_id: 3, attended: false },
        { id: 3, user_id: 1, event_id: 3, attended: false },
        { id: 4, user_id: 1, event_id: 3, attended: false },
        { id: 5, user_id: 1, event_id: 3, attended: false },
        { id: 6, user_id: 1, event_id: 3, attended: false },
        { id: 7, user_id: 1, event_id: 3, attended: false },
        { id: 8, user_id: 1, event_id: 2, attended: false },
        { id: 9, user_id: 1, event_id: 2, attended: false },
        { id: 10, user_id: 1, event_id: 2, attended: false },
        { id: 11, user_id: 1, event_id: 2, attended: false },
        { id: 12, user_id: 1, event_id: 2, attended: false },
        { id: 13, user_id: 1, event_id: 2, attended: false },
