 ...
 * Each player usually gets two balls per **frame**. There are ten frames.
   * On the tenth frame players get _three_ balls if the first ball was a strike.
 ...
 * The maximum possible score (a "perfect game") is 300.
...
Using what you already know about the language, write a program which scores a game assuming you already know how many pins were knocked down in each frame. You can come up with your own way to represent that data, but we suggest to begin with you use something like this example:
